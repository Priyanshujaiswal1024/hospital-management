 ...
 *
 * Payment confirmation email is dispatched via {@link NotificationDispatcher}
 * — Kafka or direct, always fault-tolerant.
 */
@Slf4j
@Service
...
public class BillService {
    ...
    // =========================================================================
    //  GENERATE BILL
    //  (No email here — MedicalRecordService sends it after record creation)
    // =========================================================================
    @Transactional
    public BillResponseDto generateBill(Long appointmentId) {
        ...
        log.info("Bill generated: id={} appointment={} total={}",
                saved.getId(), appointmentId, totalAmount);
    ...
    public BillResponseDto markBillAsPaid(Long billId) {
        ...
        // Payment confirmation email — fault-tolerant
        notificationDispatcher.sendPaymentConfirmed(
                bill.getAppointment().getPatient().getUser().getUsername(),
    ...
    // =========================================================================
    //  GET BILLS FOR LOGGED-IN PATIENT
    // =========================================================================
    ...
    // =========================================================================
    //  GENERATE INVOICE PDF  (unchanged — PDF logic not touched)
    // =========================================================================
    @Transactional(readOnly = true)
    public byte[] generateInvoicePdf(Long billId) throws Exception {
        ...
        double total = bill.getTotalAmount() != null
                ? bill.getTotalAmount() : bill.getConsultationFee() + gst;
        ...
        Paragraph statusStamp = new Paragraph(
                isPaid ? "✓ PAID" : "⚠ PAYMENT PENDING", isPaid ? greenFont : redFont);
