...
export default function PatientProfile() {
    ...
    async function fetchProfile() {
        try {
            ...
            // ✅ FIX 1: replace:true — history mein /patient/profile entry nahi rahegi
            // Back arrow press karne par yahan nahi aayega
    ...
    // ✅ FIX 2: !profile guard — profile null hone par crash nahi hoga
    // fetchProfile catch mein navigate hone se pehle yeh spinner dikhega
        ...
        <div style={{display:'flex',flexDirection:'column',background:'#f0f4f8',fontFamily:"'DM Sans','Outfit',sans-serif",minHeight:'100%'}}>
            ...
            <div className="pp-hero-pad" style={{
                ...
                <div className="hero-grid">
                    ...
                    {/* ── RIGHT: Insurance card + edit buttons ── */}
                    <div className="ins-right" style={{display:'flex',flexDirection:'column',alignItems:'flex-end',gap:12}}>
                        ...
                        {insuranceLoading ? (
                            ...
                            <div className="ins-card" onClick={()=>navigate('/patient/insurance')}
                                 style={{
                                     ...
                                     background:insBg, boxShadow:insShadow, padding:'20px 24px',
