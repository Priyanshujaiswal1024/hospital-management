...
export default function AdminDashboard() {
    ...
    const quickActions = [
        { icon:'👨‍⚕️', label:'Add Doctor',   sub:'Register new doctor', to:'/admin/doctors',     bg:'#eff6ff', color:'#2563eb' },
        { icon:'🏥',   label:'Department',   sub:'Manage departments',   to:'/admin/departments', bg:'#ecfeff', color:'#0891b2' },
        { icon:'💊',   label:'Medicines',    sub:'Stock & formulary',    to:'/admin/medicines',   bg:'#f0fdf4', color:'#059669' },
        { icon:'💰',   label:'Billing',      sub:'Revenue & invoices',   to:'/admin/bills',       bg:'#fffbeb', color:'#d97706' },
    ];
    ...
    return (
        <div style={{ display:'flex', flexDirection:'column', minHeight:'100%', background:'#f0f4f8', fontFamily:"'DM Sans','Outfit',sans-serif", width:'100%', minWidth:0, boxSizing:'border-box', overflowX:'hidden' }}>
            <style>{`
                ...
                .adsc { animation:fadeUp .4s ease both; transition:transform .18s,box-shadow .18s; }
                ...
                /* ── Responsive Grids — auto-fit so they work in sidebar layout ── */
                .ad-stat-grid  { display:grid; grid-template-columns:repeat(auto-fit,minmax(130px,1fr)); gap:10px; }
                .ad-qa-grid    { display:grid; grid-template-columns:repeat(auto-fit,minmax(150px,1fr)); gap:10px; }
                .ad-chart-grid { display:grid; grid-template-columns:repeat(auto-fit,minmax(260px,1fr)); gap:14px; }
                .ad-bot-grid   { display:grid; grid-template-columns:repeat(auto-fit,minmax(240px,1fr)); gap:14px; }
                ...
                @media (max-width:640px) {
                    .ad-stat-grid  { grid-template-columns:repeat(2,1fr)!important; gap:8px!important; }
                    .ad-qa-grid    { grid-template-columns:repeat(2,1fr)!important; gap:8px!important; }
                    .ad-chart-grid { grid-template-columns:1fr!important; }
                    .ad-bot-grid   { grid-template-columns:1fr!important; }
                    .ad-hero-btns button { font-size:10px!important; padding:6px 12px!important; }
                    .ad-section-pad { padding:14px 14px!important; }
                    .ad-hero-pad   { padding:16px 14px 20px!important; }
                }
            ...
            {/* ══════ HERO ══════ */}
            <div className="ad-hero-pad" style={{ background:'linear-gradient(140deg,#06152b 0%,#0a2342 35%,#0f3460 68%,#185FA5 100%)', padding:'22px 24px 28px', position:'relative', overflow:'hidden', flexShrink:0, width:'100%', boxSizing:'border-box', minWidth:0 }}>
                ...
                <div className="ad-hero-top" style={{ marginBottom:20, animation:'fadeIn .5s ease' }}>
                    <div style={{ minWidth:0 }}>
                        ...
                        <div style={{ fontSize:20, fontWeight:700, color:'#fff', fontFamily:"'Lora',serif", lineHeight:1.15, marginBottom:5 }}>
                            Admin Dashboard
                        </div>
            ...
            {/* ══════ BODY ══════ */}
            <div className="ad-section-pad" style={{ flex:1, padding:'18px 24px', display:'flex', flexDirection:'column', gap:16, width:'100%', boxSizing:'border-box', minWidth:0, overflowX:'hidden' }}>
                    ...
                    <div className="ad-qa-grid">
                        {quickActions.map(q => (
                            <button key={q.label} className="adqa"
                                    ...
                                    style={{ display:'flex', alignItems:'center', gap:11, padding:'13px 15px', borderRadius:14, border:'1px solid #e2e8f0', background:'#fff', boxShadow:'0 1px 4px rgba(0,0,0,.04)', textAlign:'left', width:'100%', boxSizing:'border-box', minWidth:0, cursor:'pointer' }}>
